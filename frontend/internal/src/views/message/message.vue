            ...
            <transition name="back-message-list">
                <div v-if="!showMesTitleList" class="message-view-content-con">
                    <div class="message-content-top-bar">
                        <span class="mes-back-btn-con"><Button type="text" @click="backMesTitleList"><Icon type="chevron-left"></Icon>&nbsp;&nbsp;Back</Button></span>
    ...
    methods: {
        ...
        getContent (index) {
            ...
            switch (this.currentMessageType + index) {
                case 'unread0': mesContent = '欢迎您。'; break;
                case 'unread1': mesContent = '欢迎您。'; break;
                case 'unread2': mesContent = '欢迎您。'; break;
