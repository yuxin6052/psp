                    ...
                    <Row>
                        ...
                        <Col span="11">
                            <FormItem label="最大人数" prop="maxMember">
                                <Input v-model.number="gameAction.maxMember" number icon="android-list"/>
                            </FormItem>
                        </Col>
                        <Col span="11">
...
export default {
  ...
  mounted () {
    this.$api.getGamesConfig(this.$route.params.id).then(res=>{
        this.gameAction.name = res.data.name
        this.gameAction.hot = res.data.hot
        this.gameAction.deleted = res.data.deleted
        this.gameAction.maxMember = res.data.maxMember
        this.gameAction.logo = res.data.logo
        this.gameAction.imgUrl = res.data.imgUrl
    })
